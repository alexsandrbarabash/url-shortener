...
для редіса але я думаю одного інстанса буде достатньо. Інший  варіант можна поставити якись гетевей перед бекендом який буде кешувати запити і бек буде завантажений лише на створені силки. Все таки по домену даного сервіса єдиний кейс завантаженості це те що умовний блогер створив short link і кинув в чат з сотнями тисяч людей і вони всі переходять по ній і це один і той же запит який можна закешувати. 
